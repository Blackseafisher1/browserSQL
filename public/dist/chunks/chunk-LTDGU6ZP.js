import{a as n,b as e,c as l,d as m,e as t,f as E,g as d,h as i,i as o,k as u}from"./chunk-PG56YYAZ.js";var p=[{id:"02-explore-editor",module:2,title:"Explore the Editor",type:"theory",file:"02-explore-editor.md",markdown:`# Explore the Editor
...
`,seed:E,check:{type:"result",expectedSql:"SELECT customers.name AS customer, products.name AS product, orders.quantity FROM customers INNER JOIN orders ON customers.id = orders.customer_id INNER JOIN products ON orders.product_id = products.id;"}},{id:"31-join-mastery",module:6,title:"Join Mastery",type:"practice",file:"31-join-mastery.sql",markdown:`# Join Mastery
...
COMMIT;
`,seed:"",check:{type:"changes",min:1}}];var C=[{id:"53-views",module:11,title:"Views",type:"practice",file:"53-views.sql",markdown:`# Views
...
**Goal:** know when to denormalize and the trade-offs.`,question:{prompt:"When is denormalization useful?",options:["Always","When read performance matters more than write efficiency","Never","When data must be unique"],answer:1,explanation:"Denormalization speeds up reads at the cost of redundancy."},seed:""}];var se={1:"Relational Database Theory",2:"Database Fundamentals",3:"Schema & Constraints",4:"CRUD Operations",5:"Query Power Tools",6:"Joins",7:"Subqueries & CTEs",8:"Normalization",9:"Indexes & Performance",10:"Transactions",11:"Advanced Topics"};function s(O){return O.map((r,c)=>({...r,_order:r.order??c})).sort((r,c)=>r._order-c._order)}var ne=[...S,...s(p),...s(T),...s(h),...s(R),...s(y),...s(N),...s(L),...s(I),...s(A),...s(C)];export{se as a,ne as b};
